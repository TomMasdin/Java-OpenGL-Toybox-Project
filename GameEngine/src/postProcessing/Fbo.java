...
public class Fbo {
	...
	private boolean multisampleMultiTarget = false;
	...
	public Fbo(int width, int height) {
		this.width = width;
		this.height = height;
		this.multisampleMultiTarget = true;
	...
	private void determineDrawBuffers()
	{
		...
		if(this.multisampleMultiTarget)
		{
				drawBuffers.put(GL30.GL_COLOR_ATTACHMENT1);//36065
		}
		drawBuffers.flip();
	...
	private void createDepthBufferAttachment() {
		...
		if(!multisampleMultiTarget) { GL30.glRenderbufferStorage(GL30.GL_RENDERBUFFER, GL14.GL_DEPTH_COMPONENT24, width, height);}
